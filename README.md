...
> Backend API for the E-commerce domain — products, cart, orders, inventory
...
Backend API for the **E-commerce** domain. Serves these frontends:

| Repo | Framework |
|------|-----------|
| forgedev-ecommerce-react | React |
| forgedev-ecommerce-vue | Vue |
